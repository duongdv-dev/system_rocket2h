...
from compare_results import run_out_of_sample_comparison
...
def ensure_filter_executed():
    """Luôn thực thi Backtest 2023-2024 bằng mô hình AI hiện có để cập nhật báo cáo mới nhất."""
    print("Executing Out-of-Sample Backtest (2023-2024) using latest AI Model...")
    try:
        run_out_of_sample_comparison()
    except Exception as e:
        print(f"Error running comparison: {e}")

class FilterDashboardHandler(SimpleHTTPRequestHandler):
...
def run_server(port=8002):
    ensure_filter_executed()
    server_address = ('', port)
    httpd = HTTPServer(server_address, FilterDashboardHandler)
    print(f"\n==================================================================")
    print(f"🚀 AI Daily Trade Risk Filter Dashboard Running on Port {port}")
