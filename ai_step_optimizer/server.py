...
from compare_step_results import run_master_system_comparison
...
def ensure_master_backtest_executed():
    """Luôn thực thi Backtest Master System để cập nhật báo cáo mới nhất."""
    print("Executing Master System Backtest (2023-2024)...")
    try:
        run_master_system_comparison()
    except Exception as e:
        print(f"Error running master system comparison: {e}")
